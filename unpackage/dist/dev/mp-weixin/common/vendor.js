...
/***/ 15:
/*!********************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/store/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var _music = _interopRequireDefault(__webpack_require__(/*! ./music */ 17));
var _novel = _interopRequireDefault(__webpack_require__(/*! ./novel */ 20));function _interopRequireDefault(obj) {return obj && obj.__esModule ? obj : { default: obj };}_vue.default.use(_vuex.default);var _default =


new _vuex.default.Store({
  modules: {
    music: _music.default,
    novel: _novel.default } });exports.default = _default;
...
/***/ 17:
/*!**************************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/store/music/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var getters = {
  //歌曲的提示列表
  searchTipList: function searchTipList(state) {
    return state.searchTipList;
  },
  songList: function songList(state) {
    return state.songList;
  },
  songDetail: function songDetail(state) {
    return state.songDetail;
  },
  bgAudioMannager: function bgAudioMannager(state) {
    return state.bgAudioMannager;
  },
  isPlaying: function isPlaying(state) {
    return state.isPlaying;
  },
  playBoxShow: function playBoxShow(state) {
...
var mutations = {
  ...
  //设置提示列表
  SET_SEARCHLIST: function SET_SEARCHLIST(state) {var arr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    state.searchTipList = arr;
  },
  //设置歌曲列表
  SET_SONGLIST: function SET_SONGLIST(state) {var arr = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    state.songList = arr;
  },
  SET_NOMORE: function SET_NOMORE(state) {var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    state.nomore = status;
  },
  SET_PAGE: function SET_PAGE(state) {var page = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : 1;
    state.currentPage = page;
  },
  //设置歌曲详情
  SET_SONGDETAIL: function SET_SONGDETAIL(state) {var obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    state.songDetail = obj;
  },
  //设置播放状态
  SET_PLAYSTATUS: function SET_PLAYSTATUS(state) {var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    state.isPlaying = status;
  },
  SET_PLAYBOXSHOW: function SET_PLAYBOXSHOW(state) {var status = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true;
    state.playBoxShow = status;
  },

  //播放音乐
  play_music: function play_music(state) {
...
var actions = {
  //获取提示列表
  getSearchList: function getSearchList(_ref, keyword) {var state = _ref.state,commit = _ref.commit,dispatch = _ref.dispatch;
    return new Promise(function (resolve, reject) {
      (0, _index.get)(_config.searchTipUrl, {
        keyword: keyword }).
  ...
  //获取歌曲列表
  getSongList: function getSongList(_ref2) {var state = _ref2.state,commit = _ref2.commit,dispatch = _ref2.dispatch;var obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    if (state.nomore) {
      (0, _index.showToast)('没有更多');
      return;
    };
    return new Promise(function (resolve, reject) {
      (0, _index.get)(_config.songsearchUrl, _objectSpread({},
      obj, {
      ...
      then(function (res) {
        if (res.code == 200) {
          ...
          if (listData && listData.length > 0) {
            var songList = [].concat(_toConsumableArray(state.songList), _toConsumableArray(listData));
  ...
  //获取歌曲真实地址，
  getSongDetail: function getSongDetail(_ref3, hash) {var state = _ref3.state,commit = _ref3.commit,dispatch = _ref3.dispatch;
    return new Promise(function (resolve, reject) {
      (0, _index.get)(_config.playUrl, {
        r: "play/getdata",
        hash: hash }).
...
/***/ 18:
/*!********************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/utils/index.js ***!
  \********************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {

"use strict";
/* WEBPACK VAR INJECTION */(function(uni) {Object.defineProperty(exports, "__esModule", { value: true });exports.downloadImg = downloadImg;exports.checkHtml = checkHtml;exports.deleteSessionTokenStr = deleteSessionTokenStr;exports.showToast = showToast;exports.showModal = showModal;exports.showTipPending = showTipPending;exports.get = get;exports.post = post;exports.getLocalStorage = getLocalStorage;exports.removeLocalStorage = removeLocalStorage;exports.setLocalStorage = setLocalStorage;exports.numberDouble = numberDouble;exports.forMatDate = forMatDate;exports.copyClipBoardData = copyClipBoardData;exports.uploadFile = uploadFile;exports.uploadVideo = uploadVideo;exports.uploadMulFiles = uploadMulFiles;exports.getTitleBarHeight = getTitleBarHeight;exports.getSystemIsIOS = getSystemIsIOS;exports.isIPhoneX = isIPhoneX;exports.wx_pay = wx_pay;exports.getRandomColor = getRandomColor;exports.checkPhone = checkPhone;exports.setCartNum = setCartNum;exports.toThousands = toThousands;exports.formatTime = formatTime;exports.formatTime2 = formatTime2;exports.sendCode = sendCode;exports.parseQueryString = parseQueryString;exports.createQrcode = createQrcode;exports.fomartTimeToSecondString = fomartTimeToSecondString;var _config = __webpack_require__(/*! @/config.js */ 19);function _objectSpread(target) {for (var i = 1; i < arguments.length; i++) {var source = arguments[i] != null ? arguments[i] : {};var ownKeys = Object.keys(source);if (typeof Object.getOwnPropertySymbols === 'function') {ownKeys = ownKeys.concat(Object.getOwnPropertySymbols(source).filter(function (sym) {return Object.getOwnPropertyDescriptor(source, sym).enumerable;}));}ownKeys.forEach(function (key) {_defineProperty(target, key, source[key]);});}return target;}function _defineProperty(obj, key, value) {if (key in obj) {Object.defineProperty(obj, key, { value: value, enumerable: true, configurable: true, writable: true });} else {obj[key] = value;}return obj;}

function request(url, method, data) {var showLoading = arguments.length > 3 && arguments[3] !== undefined ? arguments[3] : true;
  return new Promise(function (resolve, reject) {
    if (showLoading) {
      uni.showLoading({
        title: '加载中...' });
...
//下载图片
function downloadImg(img) {var showLoading = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
  if (showLoading) {
    uni.showLoading({
      title: '生成中...' });
...
function deleteSessionTokenStr(url) {
...
//将时间戳转为日期时间
function forMatDate(date) {var default_val = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : true; //中国标准时间对象
...
//上传单张图片
function uploadFile(file) {var data = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
  uni.showLoading({
    title: '上传中...' });
...
//上传多张图片
function uploadMulFiles(files) {
  return new Promise(function (resolve, reject) {
    var filesLen = files.length;
    var count = 0;
    var pathsArr = []; //返回的图品地址
    upload();
    function upload() {
      if (count < filesLen) {
...
function getTitleBarHeight() {
  ...
  var titleBarHeight = totalTopHeight - result.statusBarHeight;
  return {
    totalTopHeight: totalTopHeight, //总高度
...
function formatTime2(time) {
  var _time = new Date(time.replace(/-/g, '/'));
  var day = _time.getDate();
  var now_day = new Date().getDate();
...
//将时间S转为 1'20"形式
function fomartTimeToSecondString(time) {
  time = Number(time);
  if (time < 60) {
    return time + '"';
  } else {
...
/***/ 19:
/*!***************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/config.js ***!
  \***************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
//发送短信验证码
var sendSmsUrl = "".concat(host, "api/v1/xxx");
//注册
var registerUrl = "".concat(host, "api/v1/register");
//登陆
var loginUrl = "".concat(host, "api/v1/login");

//获取用户信息
var getUserInfoUrl = "".concat(host, "api/v1/getUserInfo");
//修改个人资料
var modifyUserInfoUrl = "".concat(host, "api/v1/modifyUserInfo");


//上传接口
var uploadFileUrl = "".concat(host, "api/v1/upload");


//获取省市区数据接口
var getAreaUrl = "".concat(host, "api/v1/area");



//搜索接口
var songsearchUrl = "".concat(host, "api/v1/songsearch");
//获取歌曲源数据接口，，经常犯毛病
var playUrl = "".concat(host, "api/v1/play");
//该接口获取有问题了
//const playUrl = "https://v1.itooi.cn/kugou/song";
//搜索框关键词提示接口
var searchTipUrl = "".concat(host, "api/v1/searchtip");


//获取视频分类,视频接口不开放
var getVideoSortUrl = "".concat(host, "xxxxx");
//获取视频列表
var getVideoListUrl = "".concat(host, "xxxxx");




/**小说接口 start**/
var host1 = 'http://api.zhuishushenqi.com/';
//获取所有分类
var getAllSortUrl = "".concat(host1, "cats/lv2/statistics");
//模糊搜索，根据关键词搜索
var getBookByWordUrl = "".concat(host1, "book/fuzzy-search");
//获取分类详情
var getSortDetailUrl = "".concat(host1, "book/by-categories");
//获取小说简介信息
var getBookDescUrl = "".concat(host1, "book");
//获取小说章节列表
var getBookChaptersUrl = "".concat(host1, "mix-atoc/");
//获取章节内容详情
var getChapterContentUrl = 'http://chapter2.zhuishushenqi.com/chapter/';
...
module.exports = {
  ...
  modifyUserInfoUrl: modifyUserInfoUrl,
  getAreaUrl: getAreaUrl,
  uploadFileUrl: uploadFileUrl,

  songsearchUrl: songsearchUrl,
  playUrl: playUrl,
  searchTipUrl: searchTipUrl,
  getVideoSortUrl: getVideoSortUrl,
  getVideoListUrl: getVideoListUrl,


  /**小说 start**/
  getAllSortUrl: getAllSortUrl,
  getBookByWordUrl: getBookByWordUrl,
  getSortDetailUrl: getSortDetailUrl,
  getBookDescUrl: getBookDescUrl,
  getBookChaptersUrl: getBookChaptersUrl,
  getChapterContentUrl: getChapterContentUrl
  /**小说 end**/ };
...
/***/ 20:
/*!**************************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/store/novel/index.js ***!
  \**************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
var state = {
  ...
  **/
  bookStore: (0, _index.getLocalStorage)('bookStore') || [],
  bookIndex: 0 //小说看的章的序列号
};

var getters = {
  navArr: function navArr(state) {
    return state.navArr;
  },
  bookStore: function bookStore(state) {
    return state.bookStore;
  },
  bookIndex: function bookIndex(state) {
...
var mutations = {
  SET_AVARR: function SET_AVARR(state) {var list = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    state.navArr = list;
  },
  SET_BOOKSTORE: function SET_BOOKSTORE(state) {var list = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : [];
    state.bookStore = list;
    (0, _index.setLocalStorage)('bookStore', list);
  },
  /**获取该小说看到了第几章
     * 根据小说的id，
     * 如果没有该小说就为1， 反之就去storage中取
      * **/
  GET_BOOKINDEX: function GET_BOOKINDEX(state, id) {
    var books = state.bookStore;
    var index = 0;
  ...
  /**设置该小说看到了第几章
     ...
     * 如果没有该小说就为1， 反之就去storage中取
      * **/
  SET_BOOKINDEX: function SET_BOOKINDEX(state) {var obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var books = state.bookStore;
    for (var i = 0, len = books.length; i < len; i++) {
    ...
    (0, _index.setLocalStorage)('bookStore', books);
    state.bookIndex = obj.index;
  },
  //添加小说
  ADD_BOOK: function ADD_BOOK(state) {var obj = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : {};
    var id = obj.id;
    var bookStore = state.bookStore;
    var hasOne = false;
    for (var i = 0, len = bookStore.length; i < len; i++) {
    ...
    (0, _index.setLocalStorage)('bookStore', bookStore);
    (0, _index.showToast)('添加成功');
  } };
...
var actions = {
  //获取所有分类
  getAllSortList: function getAllSortList(_ref) {var state = _ref.state,commit = _ref.commit,dispatch = _ref.dispatch;
    return new Promise(function (resolve, reject) {
      (0, _index.get)(_config.getAllSortUrl, {}).
      then(function (data) {
        if (data['ok']) {
          var list = [];
          for (var key in data) {
  ...
  //获取小说章节信息
  getNovelChapters: function getNovelChapters(_ref2, id) {var state = _ref2.state,commit = _ref2.commit,dispatch = _ref2.dispatch;
    return new Promise(function (resolve, reject) {
      var url = "".concat(_config.getBookChaptersUrl).concat(id, "?view=chapters");
      (0, _index.get)(url, {}).
      then(function (res) {
        if (res.ok) {
          resolve(res.mixToc.chapters);
        } else {
          (0, _index.showToast)('网络出错');
          reject();
        }
      });
    });
  ...
  //获取章节详情内容
  getChaptersContent: function getChaptersContent(_ref3, link) {var state = _ref3.state,commit = _ref3.commit,dispatch = _ref3.dispatch;
    return new Promise(function (resolve, reject) {
      var url = "".concat(_config.getChapterContentUrl).concat(link);
      (0, _index.get)(url, {}).
      then(function (res) {
        if (res.ok) {
          resolve(res.chapter.body);
        } else {
          (0, _index.showToast)('网络错误');
          reject();
        }
      });
    });
...
/***/ 4:
/*!****************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/pages.json ***!
  \****************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
...
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });exports.default = void 0;var _default = { "pages": { "pages/index/index": { "navigationBarTitleText": "搜书", "enablePullDownRefresh": true }, "pages/me/me": { "navigationBarTitleText": "我的" }, "pages/search/search": { "navigationBarTitleText": "搜索" }, "pages/movie/movie": { "navigationBarTitleText": "详情界面" }, "pages/collection/collection": { "navigationBarTitleText": "收藏", "enablePullDownRefresh": true, "navigationStyle": "custom" }, "pages/rank/rank": { "navigationBarTitleText": "排行榜", "enablePullDownRefresh": true, "navigationStyle": "custom" }, "pages/bookDetail/bookDetail": { "navigationBarTitleText": "图书详情", "enablePullDownRefresh": true }, "pages/cooperation/cooperation": { "navigationBarTitleText": "互助", "enablePullDownRefresh": true }, "pages/host_post/host_post": { "navigationBarTitleText": "热推", "enablePullDownRefresh": true }, "pages/login/login": { "navigationBarTitleText": "登录", "enablePullDownRefresh": true }, "pages/meFace/meFace": { "navigationBarTitleText": "我的头像", "enablePullDownRefresh": true }, "pages/meInfo/meInfo": { "navigationBarTitleText": "个人中心", "enablePullDownRefresh": true }, "pages/meNickname/meNickname": { "navigationBarTitleText": "修改昵称", "enablePullDownRefresh": true }, "pages/message/message": { "navigationBarTitleText": "message", "enablePullDownRefresh": true }, "pages/notice/notice": { "navigationBarTitleText": "notice", "enablePullDownRefresh": true }, "pages/setting/setting": { "navigationBarTitleText": "设置", "enablePullDownRefresh": true }, "pages/sex/sex": { "navigationBarTitleText": "修改性别", "enablePullDownRefresh": true }, "pages/cooperation/put-book/detail/detail": { "navigationBarTitleText": "detail", "enablePullDownRefresh": true }, "pages/cooperation/put-book/put-book": { "navigationBarTitleText": "putBook", "enablePullDownRefresh": true }, "pages/cooperation/post-book/post-book": { "navigationBarTitleText": "post-book", "enablePullDownRefresh": true }, "pages/cooperation/post-book/next/next": { "navigationBarTitleText": "next", "enablePullDownRefresh": true }, "pages/cooperation/post-book/null/null": { "navigationBarTitleText": "null", "enablePullDownRefresh": true }, "pages/buffer/buffer": { "navigationBarTitleText": "消息", "enablePullDownRefresh": true }, "pages/getBookData/getBookData": { "navigationBarTitleText": "数据分析", "enablePullDownRefresh": true }, "pages/sort/search": { "navigationStyle": "default", "navigationBarTitleText": "搜索", "enablePullDownRefresh": true }, "pages/sort/sort": { "navigationStyle": "default", "navigationBarTitleText": "分类", "enablePullDownRefresh": true }, "pages/sort/sort_detail": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true, "onReachBottomDistance": 50 }, "pages/sort/book_desc": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/sort/chapter_reader": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/sort/bookshelf": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/sort/chapters": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/chat/chat": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/classify/classify": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/fenlei/fenlei": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/fenlei/detail/detail": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/select/select": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/cooperation/put-book/next/next": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true }, "pages/cooperation/post-book/detail/detail": { "navigationStyle": "default", "navigationBarTitleText": "", "enablePullDownRefresh": true } }, "globalStyle": { "navigationBarTextStyle": "black", "navigationBarTitleText": "uni-app", "navigationBarBackgroundColor": "#F8F8F8", "backgroundColor": "#F8F8F8" } };exports.default = _default;

/***/ }),

/***/ 8:
/*!********************************************************************!*\
  !*** C:/Users/kuro/Desktop/BookPackage/pages.json?{"type":"stat"} ***!
  \********************************************************************/
/*! no static exports found */
/***/ (function(module, exports, __webpack_require__) {
